...
namespace AGamersGame
{
    class Sprite
    {
        ...
        public Vector2 spritePos, spriteVelocity, spriteOrigin, spriteScale, collisionInsetMin, collisionInsetMax;

        public bool flipped, isColliding, drawCollision, isDead;
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.Draw(spriteSheet, getRectangleForDraw(), animations[currentAnim][currentFrame], Color.White, 0f, spriteOrigin, drawEffect, 1f);

            if (drawCollision) spriteBatch.Draw(collisionTexture, getRectangleForCollision(), Color.Pink);
        ...
        {
            return checkCollision(otherSprite) && getEdgeBottomForCollision() < otherSprite.getEdgeBottomForCollision() && getEdgeBottomForCollision() > otherSprite.getEdgeTopForCollision() && (getEdgeLeftForCollision() + collPadding < otherSprite.getEdgeRightForCollision() && getEdgeRightForCollision() - collPadding > otherSprite.getEdgeLeftForCollision());
        }


        public bool checkCollisionAbove(Sprite otherSprite)
        {
            return checkCollision(otherSprite) && getEdgeTopForCollision() > otherSprite.getEdgeTopForCollision() && getEdgeTopForCollision() < otherSprite.getEdgeBottomForCollision() && (getEdgeLeftForCollision() + collPadding < otherSprite.getEdgeRightForCollision() && getEdgeRightForCollision() - collPadding > otherSprite.getEdgeLeftForCollision());
        }


        public bool checkCollisionLeft(Sprite otherSprite)
        {
            return checkCollision(otherSprite) && getEdgeRightForCollision() < otherSprite.getEdgeRightForCollision() && getEdgeRightForCollision() > otherSprite.getEdgeLeftForCollision() && (getEdgeTopForCollision() + collPadding < otherSprite.getEdgeBottomForCollision() && getEdgeBottomForCollision() - collPadding > otherSprite.getEdgeTopForCollision());
        }

        public bool checkCollisionRight(Sprite otherSprite)
        {
            return checkCollision(otherSprite) && getEdgeLeftForCollision() > otherSprite.getEdgeLeftForCollision() && getEdgeLeftForCollision() < otherSprite.getEdgeRightForCollision() && (getEdgeTopForCollision() + collPadding < otherSprite.getEdgeBottomForCollision() && getEdgeBottomForCollision() - collPadding > otherSprite.getEdgeTopForCollision());
        }
